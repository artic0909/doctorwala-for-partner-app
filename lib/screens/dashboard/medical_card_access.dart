...
class _MedicalCardAccessTabState extends State<MedicalCardAccessTab> {
  ...
  Future<void> _lookupPatient() async {
    ...
    setState(() {
      ...
      _foundPatient = null;
      _selectedDoctorId =
          _doctors.length == 1 ? _doctors[0]['id'] as int? : null;
    });
                              ...
                              SizedBox(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                    onPressed:
                                        _isLookingUp ? null : _lookupPatient,
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<int>(
                                    ...
                                    items:
                                        _doctors.map<DropdownMenuItem<int>>((
                                          doc,
                                        ) {
